...
- `tool_wrappers/runtime_and_preflight_wrapper.md`
...
- `generators/background_and_signal_model_generator.md`
...
- `shared/frontmatter_template.md`
- `shared/required_sections.md`
